                    ...
                    <div class="px-8 py-4">
                        <div class="flex items-center justify-between">
                            ...
                            <button @click="openCreateModal"
                                class="p-2 text-white bg-blue-500 rounded-md btn-block btn-sm hover:bg-blue-600">
            ...
            <form @submit.prevent="updateTask" class="mt-4 space-y-6">
                ...
                <div class="border-t modal-footer">
                    <div class="flex justify-end mt-3">
                        ...
                        <button type="submit"
                            class="px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:ring-1">
                            Save
                        </button>
                    </div>
                </div>
